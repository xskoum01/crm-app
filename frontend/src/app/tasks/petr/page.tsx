...
// Seznam úkolů pro Vláďu – view se řádky, klik na řádek → detail na /tasks/peta/[id],
// tlačítko "Nový úkol" → /tasks/peta/new.
...
export default function PetaTasksPage() {
  ...
  // Načtení jen úkolů pro Petra (filtr v API přes query assignee)
        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="text-sm text-slate-500">
              Seznam úkolů, které jsou přiřazené Petrovi.
            </p>
          </div>
          ...
          <button
            type="button"
            onClick={() => router.push("/tasks/peta/new")}
            ...
            <ul className="divide-y divide-slate-100">
              {filtered.map((t) => (
                <li
                  ...
                  onClick={() => router.push(`/tasks/peta/${t.id}`)}
                >
